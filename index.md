...
![treehouse_beard](./assets/images/treehouse_beard.jpg)
![treehose_finished](./assets/images/treehouse_finished.jpg)

### Garage Makeover (2018)

The previous owner of our house was a general contractor who used the garage for storing the lumber and equipment. The garage was huge, but a complete mess with narrow shelves running along the side of the garage. The picture below shows the "before".
...
![garage_storage](./assets/images/garage_storage.jpg)
![garage_shelves](./assets/images/garage_shelves.jpg)
![garage_lab](./assets/images/garage_lab.jpg)


### Garage Gym (2019)

To give the family a fun play space for the cold New England winters, I turned the garage into an indoor gym complete with a climbing wall, rope climb, pull up bar, tennis wall, boxing bag, and padded floors for olympic style weight lifting. The turned out to be a life safer when the Covid era came around. The climbing wall was the most tedious project as it involved drilling and installing hundreds of climbing/mounting holes. Most of these projects were one weekend projects. The uses have evolved as the kids have grown up, but the gym has served us well.


![garage_gym](./assets/images/garage_gym.jpg)
![garage_tennis](./assets/images/garage_tennis.jpg)

### Patio (2020)

During the Covid era, the Olofssons like the rest of the US, were going stir crazy at home and I was looking for things to do outside the house. One of the projects on my todo list since I moved in had been to create a proper sitting area in the back of the house. To keep things simple, I decided to install a paver patio rather than a full deck. This was not a small patio and turned out to be a LOT more work than I expected. It was about a week of hard work, but I am pretty happy with the results. Five years later, some of the tiles have settled a bit, so if I ever do this again I will definitely pay a lot more attention to laying the round work. (big life lesson in there!)

![patio_sled](./assets/images/patio_sled.png)

![patio_finished](./assets/images/patio_finished.jpg)

### Planter (2020)

This was another covid era project. There was a dead spot next to our greenhouse that had been been used as a parking space by the previous house owner. An order of pressure treated wood, an order of top soil, some drip irrigation piping, some chicken fencing and voila, we had a nice planter for all of our earthy project. Over the years, we have grown potatoes, carrots, herbs, and flowers in that spot.

![planter](./assets/images/planter.jpg)
...
![trampoline_dig](./assets/images/trampoline_dig.png)
![trampoline_finished](./assets/images/trampoline_finished.png)
...
![yard_before](./assets/images/yard_before.jpg)
